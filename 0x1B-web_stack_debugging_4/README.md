...
## Details
      By Sylvain Kalache, co-founder at Holberton School          Weight: 1                Ongoing project - started 02-21-2022, must end by 02-25-2022 (in about 12 hours)          - you're done with 0% of tasks.              Checker was released at 02-24-2022 12:00 AM              An auto review will be launched at the deadline       ![](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-sysadmin_devops/313/frdkCrb.jpg) 
...
### 1. User limit
          #advanced         Progress vs Score  Task Body Change the OS configuration so that it is possible to login with the   ` holberton `   user and open a file without any error message.
```bash
